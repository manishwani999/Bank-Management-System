...
create table signuptwo(form_no varchar(30), religion varchar(30), categoty varchar(30), income varchar(30), education varchar(30), occupation varchar(60), pan varchar(30), aadhar varchar(60), seniorcitizen varchar(30), existing_account varchar(30));
...
create table bank(pin varchar(30), date varchar(50), type varchar(20), amount varchar(20));
select * from bank;
